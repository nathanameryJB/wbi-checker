...
if uploaded_file is not None and not st.session_state['df_init']:
    ...
    for i, url in enumerate(urls):
        ...
        st.session_state['df_init'] = True
elif st.session_state['df_init']:
    df = st.session_state['df']

if st.session_state['df_init']:
